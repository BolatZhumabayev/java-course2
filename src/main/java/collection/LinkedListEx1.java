...
public class LinkedListEx1 {
    public static void main(String[] args) {
        ...
        Student2 st2 = new Student2("Olzhas", 2);
        Student2 st3 = new Student2("Berik", 1);
        Student2 st4 = new Student2("Mariya", 4);
        Student2 st5 = new Student2("Aigul", 3);
        ...
        System.out.println(student2LinkedList.getFirst());
        System.out.println(student2LinkedList.getLast());
